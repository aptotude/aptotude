...
storiesOf('Table', module)
  .add('Default', () =>
    <AptoTable>
        <AptoTableHead>
          <AptoTableRow>
            <AptoTableCell type="th" scope="col">#</AptoTableCell>
            <AptoTableCell type="th" scope="col">First</AptoTableCell>
            <AptoTableCell type="th" scope="col">Last</AptoTableCell>
            <AptoTableCell type="th" scope="col">Initials</AptoTableCell>
          </AptoTableRow>
        </AptoTableHead>
        <AptoTableBody>
          <AptoTableRow>
            <AptoTableCell type="th" scope="row">1</AptoTableCell>
            <AptoTableCell>John</AptoTableCell>
            <AptoTableCell>Doe</AptoTableCell>
            <AptoTableCell>JD</AptoTableCell>
          </AptoTableRow>
          <AptoTableRow>
            <AptoTableCell type="th" scope="row">2</AptoTableCell>
            <AptoTableCell>Jane</AptoTableCell>
            <AptoTableCell>Doe</AptoTableCell>
            <AptoTableCell>JD</AptoTableCell>
          </AptoTableRow>
          <AptoTableRow>
            <AptoTableCell type="th" scope="row">3</AptoTableCell>
  ...
  .add('Highlight', () =>
    <React.Fragment>
      ...
      <AptoTable>
        ...
        <AptoTableBody>
          <AptoTableRow>
            <AptoTableCell highlight="danger" type="th" scope="row">1</AptoTableCell>
    ...
    <AptoTable responsive>
        <AptoTableHead>
          <AptoTableRow>
            ...
            <AptoTableCell type="th" scope="col">Last</AptoTableCell>
            <AptoTableCell type="th" scope="col">Initials</AptoTableCell>
            <AptoTableCell type="th" scope="col">Heading</AptoTableCell>
            <AptoTableCell type="th" scope="col">Heading</AptoTableCell>
            <AptoTableCell type="th" scope="col">Heading</AptoTableCell>
            <AptoTableCell type="th" scope="col">Heading</AptoTableCell>
            <AptoTableCell type="th" scope="col">Heading</AptoTableCell>
