...
describe('Spinner Component', () => {
  it('Spinner renders', () => {
    ...
    const textNode = container.querySelector(
      '.AptoSpinner .AptoSpinner-content'
    );
  ...
  it('Spinner with no overlay renders', () => {
    const { container } = render(<AptoSpinner noOverlay />);
  ...
  it('Spinner with text renders', () => {
    const { container } = render(<AptoSpinner text="foo" />);
  ...
  it('Custom className renders', () => {
    const { container } = render(<AptoSpinner className="foo" />);
